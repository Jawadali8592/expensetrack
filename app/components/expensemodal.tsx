...
const ExpenseModal = ({ isOpen, onClose, onAddExpense,onUpdateExpense, expense }:ExpenseModalProps) => {
    ...
    type ExpenseModalProps= {
        ...
        onUpdateExpense: (updatedExpense: ExpenseType) => void;
        expense: ExpenseType;
      }
    return (
                ...
                <div className="modal-container bg-white w-96 mx-auto mt-20 p-6 rounded shadow-lg">
                    <div className="mb-4">
                        <div className='flex-col' >
                            <div className='flex justify-between 'style={{backgroundColor:"fcd5ce"}}>
                                <h3 className="text-2xl font-semibold mb-2" style={{color:"red",textShadow:"8px 8px 20px red"}}>Add Expense</h3>
